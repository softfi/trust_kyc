...
/*bond IPO is upcoming bonds---> [initial public offering bonds]*/
          ...
          children: [
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: upiIndex == 1 ? Colors.white : Color(0xff22263D)),
                child: Center(
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.sourceSansPro(
                          textStyle: TextStyle(
                              color:
                              upiIndex == 1 ? Color(0xff22263D) : Colors.white,
                              fontWeight: FontWeight.w500,
                              fontSize: 15),
                        ),
                      ),
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    border: Border.all(width: 1, color: AppColors.primaryColor),
                    color: upiIndex == 2 ? Colors.white : Color(0xff22263D)),
                child: Center(
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16.0),
                      child: Text(
                        ...
                        style: GoogleFonts.sourceSansPro(
                          textStyle: TextStyle(
                              color:
                              upiIndex == 2 ? Color(0xff22263D) : Colors.white,
                              fontWeight: FontWeight.w500,
                              fontSize: 15),
                        ),
                      ),
