...
class HTMLViewer extends StatefulWidget {
  ...
  const HTMLViewer(this.response, {Key? key}) : super(key: key);
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onPageFinished: (String url) async{
            ...
            if(url.contains("https://trust-api.trustmony.com/api/v1/esign_pdf_callback")){
              await HelperFunctions.saveuserkyccompleted(true);
              Navigator.push(context, MaterialPageRoute(builder: (builder)=>const AllDocsView()));
            }
          },
