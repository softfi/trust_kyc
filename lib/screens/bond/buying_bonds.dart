...
<<<<<<< HEAD
          ...
          subtitle: Text("The document contains high-quality data which is fetched from SEBI and Exchange websites to help you make an informed decision.",style: GoogleFonts.sourceSansPro(
            textStyle: const TextStyle(
              color: Color(0xffFFFFFF), fontWeight: FontWeight.w400, fontSize: 12,),
          )),
        )
    );
=======
        ...
        children: [
          ListTile(
            title: Text("Upcoming issues",style: GoogleFonts.quicksand(
              textStyle: const TextStyle(
                  color: Color(0xff22263D), fontWeight: FontWeight.bold, fontSize: 20),
            ),),
            subtitle: Text("As declared by RBI, Gold bonds are issued every month. You can also easily plan your gold investments.",style:GoogleFonts.sourceSansPro(
              textStyle: const TextStyle(
                  color: Color(0xff1C1C1C), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
            ) ,),
          ),
              ...
              TableRow(
                  children: [
                     Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text("S.no",style:GoogleFonts.sourceSansPro(
                            textStyle: const TextStyle(
                                color: Color(0xffFFFFFF), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
                          ) ,),
                        ),
                      ),
                   ...
                   Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text("Issue Name*",style:GoogleFonts.sourceSansPro(
                          textStyle: const TextStyle(
                              color: Color(0xffFFFFFF), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
                        ) ,),
                      ),),
                     ...
                     Container(
                        ...
                        child: Expanded(
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text("Subscription Dates",style:GoogleFonts.sourceSansPro(
                              textStyle: const TextStyle(
                                  color: Color(0xffFFFFFF), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
                            ) ,),
                          ),
              ...
              TableRow(
                children: [
                 Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text("1",style:GoogleFonts.sourceSansPro(
                          textStyle: const TextStyle(
                              color: Color(0xff22263D), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
                        )),
                      ),
               ...
               Container( alignment: Alignment.center,
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("2020-21 Series X|",style:GoogleFonts.sourceSansPro(
                        textStyle: const TextStyle(
                            color: Color(0xff22263D), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
                      )),
                    ),
                  ...
                  Container( alignment: Alignment.center,
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("Oct 12, 2020 - Oct 16, 2020",style:GoogleFonts.sourceSansPro(
                        textStyle: const TextStyle(
                            color: Color(0xff22263D), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
                      )),
                    ),
              ...
              TableRow(
                  children: [
                    Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text("2",style:GoogleFonts.sourceSansPro(
                          textStyle: const TextStyle(
                              color: Color(0xff22263D), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
                        )),
                      ),
              ...
              TableRow(
                  children: [
                    Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text("3",style:GoogleFonts.sourceSansPro(
                          textStyle: const TextStyle(
                              color: Color(0xff22263D), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
                        )),
                      ),
              ...
              TableRow(
                  children: [
                    Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text("4",style:GoogleFonts.sourceSansPro(
                          textStyle: const TextStyle(
                              color: Color(0xff22263D), fontWeight: FontWeight.w400, fontSize: 15,letterSpacing: 0),
                        )),
                      ),
